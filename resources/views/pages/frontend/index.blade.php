    ...
    <section class="flex items-center hero">
        ...
        <div class="w-full inset-0 md:relative md:w-1/2">
          <div class="relative hero-image">
            ...
            <img
              src="/fe/images/content/image-section-1.png"
              alt="hero 1"
          ...
          <div class="grid grid-rows-2 grid-cols-9 gap-4">
            ...
            >
              <div class="card-shadow rounded-xl">
                <img
                  src="/fe/images/content/image-catalog-1.png"
                  alt=""
            ...
            >
              <div class="card-shadow rounded-xl">
                <img
                  src="/fe/images/content/image-catalog-3.png"
                  alt=""
                  class="w-full h-full object-cover object-center overlay overflow-hidden rounded-xl"
                />
              </div>
            ...
            >
              <div class="card-shadow rounded-xl">
                <img
                  src="/fe/images/content/image-catalog-4.png"
                  alt=""
                  class="w-full h-full object-cover object-center overlay overflow-hidden rounded-xl"
                />
              </div>
            ...
            <div class="relative col-span-9 row-span-1 md:col-span-4 card">
              <div class="card-shadow rounded-xl">
                <img
                  src="/fe/images/content/image-catalog-2.png"
                  alt=""
                  class="w-full h-full object-cover object-center overlay overflow-hidden rounded-xl"
                />
              </div>
          ...
          <div class="flex -mx-4 flex-row relative">
            ...
            <div class="px-4 relative card group">
              ...
              >
                ...
                <img
                  src="/fe/images/content/image-arrived-1.png"
                  alt=""
            ...
            <div class="px-4 relative card group">
              ...
              >
                ...
                <img
                  src="/fe/images/content/image-arrived-2.png"
                  alt=""
                  class="w-full h-full object-cover object-center"
                />
              </div>
            ...
            <div class="px-4 relative card group">
              ...
              >
                ...
                <img
                  src="/fe/images/content/image-arrived-3.png"
                  alt=""
                  class="w-full h-full object-cover object-center"
                />
              </div>
            ...
            <div class="px-4 relative card group">
              ...
              >
                ...
                <img
                  src="/fe/images/content/image-arrived-4.png"
                  alt=""
                  class="w-full h-full object-cover object-center"
                />
              </div>
            ...
            <div class="px-4 relative card group">
              ...
              >
                ...
                <img
                  src="/fe/images/content/image-arrived-5.png"
                  alt=""
                  class="w-full h-full object-cover object-center"
                />
              </div>
      ...
      <section class="container mx-auto">
        <div class="flex justify-center flex-wrap">
          ...
          >
            <img src="/fe/images/content/logo-adobe.svg" alt="" class="mx-auto" />
          </div>
          <div
            class="w-full flex-auto md:w-auto md:flex-initial px-4 md:px-6 my-4 md:my-0"
          >
            <img src="/fe/images/content/logo-ikea.svg" alt="" class="mx-auto" />
          </div>
          <div
            class="w-full flex-auto md:w-auto md:flex-initial px-4 md:px-6 my-4 md:my-0"
          >
            <img
              src="/fe/images/content/logo-hermanmiller.svg"
              alt=""
              class="mx-auto"
            />
          </div>
          <div
            class="w-full flex-auto md:w-auto md:flex-initial px-4 md:px-6 my-4 md:my-0"
          >
            <img src="/fe/images/content/logo-miele.svg" alt="" class="mx-auto" />
          </div>
        </div>
      </section>
      <!-- END: CLIENTS -->
