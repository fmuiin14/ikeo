          ...
          <div class="slider">
            <div class="thumbnail">
              <div class="px-2">
                <div
                  class="item selected"
                  data-img="/fe/images/content/showcase-1.front.jpg"
                >
                  <img
                    src="/fe/images/content/showcase-1.front.jpg"
                    alt="front"
              ...
              <div class="px-2">
                <div
                  class="item"
                  data-img="/fe/images/content/showcase-1.back.jpg"
                >
                  <img
                    src="/fe/images/content/showcase-1.back.jpg"
                    alt="back"
                    class="object-cover w-full h-full rounded-lg"
                  />
                </div>
              ...
              <div class="px-2">
                <div
                  class="item"
                  data-img="/fe/images/content/showcase-1.rear.jpg"
                >
                  <img
                    src="/fe/images/content/showcase-1.rear.jpg"
                    alt="rear"
                    class="object-cover w-full h-full rounded-lg"
                  />
                </div>
              ...
              <div class="px-2">
                <div
                  class="item"
                  data-img="/fe/images/content/showcase-1.side.jpg"
                >
                  <img
                    src="/fe/images/content/showcase-1.side.jpg"
                    alt="side"
                    class="object-cover w-full h-full rounded-lg"
                  />
                </div>
              ...
              <div class="px-2">
                <div
                  class="item"
                  data-img="/fe/images/content/showcase-1.top.jpg"
                >
                  <img
                    src="/fe/images/content/showcase-1.top.jpg"
                    alt="top"
                    class="object-cover w-full h-full rounded-lg"
                  />
                </div>
        ...
        <div class="flex overflow-x-auto mb-4 -mx-3">
          <div class="px-3 flex-none" style="width: 320px">
            <div class="rounded-xl p-4 pb-8 relative bg-white">
              <div class="rounded-xl overflow-hidden card-shadow w-full h-36">
                <img
                  src="/fe/images/content/chair-1.png"
                  alt=""
          ...
          <div class="px-3 flex-none" style="width: 320px">
            <div class="rounded-xl p-4 pb-8 relative bg-white">
              <div class="rounded-xl overflow-hidden card-shadow w-full h-36">
                <img
                  src="/fe/images/content/chair-2.png"
                  alt=""
                  class="w-full h-full object-cover object-center"
                />
              </div>
          ...
          <div class="px-3 flex-none" style="width: 320px">
            <div class="rounded-xl p-4 pb-8 relative bg-white">
              <div class="rounded-xl overflow-hidden card-shadow w-full h-36">
                <img
                  src="/fe/images/content/chair-3.png"
                  alt=""
                  class="w-full h-full object-cover object-center"
                />
              </div>
